...
namespace TestSample
{
    ...
    public class RsaHelper
    {
        ...
        /// 加密
        /// </summary>
        /// <param name="message">待加密的报文</param>
        ...
        public static string Encrypt(string message, string publicKey)
        {
            ...
            {
                return Encrypt2(message, publicKey);
            }
            ...
            //cipher = WebUtility.UrlEncode(cipher);
            return cipher;
        }
        ...
        {
            if (cipher.Length>117)
            {
                return Decrypt2(cipher, privateKey);
            }
        ...
        private static string Encrypt2(string message, string publicKey)
        {
            RSA rsa = CreateRsaFromPublicKey(publicKey);
        ...
        private static string Decrypt2(string cipher,string privateKey)
        {
            var rsa = CreateRsaFromPrivateKey(privateKey);
            ...
            if (CiphertextData.Length <= MaxBlockSize)
                return System.Text.Encoding.UTF8.GetString(rsa.Decrypt(CiphertextData, RSAEncryptionPadding.Pkcs1));
        ...
        private static RSA CreateRsaFromPrivateKey(string privateKey)
        {
            ...
            privateKey = privateKey.SafeToString().Replace("-----BEGIN RSA PRIVATE KEY-----", "")
